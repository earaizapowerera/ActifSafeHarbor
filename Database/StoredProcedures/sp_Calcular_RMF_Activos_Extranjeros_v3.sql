-- =============================================
-- DROP y RE-CREATE del Stored Procedure v3
-- CAMBIOS v3:
-- - Corregidos TODOS los nombres de columnas según estructura real
-- - Cambiado filtro FLG_PROPIO = 0 a FLG_PROPIO = 1 (temporal para pruebas)
-- =============================================
...
BEGIN
    ...
    PRINT '========================================';
    PRINT 'Iniciando cálculo RMF Activos Extranjeros v3';
    ...
    -- NOTA: Cambiado temporalmente FLG_PROPIO = 1 para pruebas (datos test tienen valor 1)
    ...
    WHERE s.ID_Compania = @ID_Compania
      ...
      AND s.FLG_PROPIO = 1  -- TEMPORAL: Cambiado de 0 a 1 para pruebas con datos actuales
      AND s.ID_PAIS > 1
    ...
    -- 13. Insertar resultados en Calculo_RMF CON NOMBRES CORRECTOS DE LA TABLA REAL
...
PRINT 'Stored procedure sp_Calcular_RMF_Activos_Extranjeros v3.0 creado exitosamente';
GO
