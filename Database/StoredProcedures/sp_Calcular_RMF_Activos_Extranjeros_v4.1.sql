-- =============================================
-- DROP y RE-CREATE del Stored Procedure v4.1
-- CAMBIOS v4.1:
-- - CORRECCIÓN: Cálculo de Meses_Hasta_Mitad_Periodo según fórmulas Excel
-- - CASO 2: Adquirido antes junio - Debe contar meses INCLUSIVE
-- - CASO 4: Dado de baja - Debe usar la mitad de los meses usados, no MIN(mes, 6)
-- =============================================
...
BEGIN
    ...
    PRINT '========================================';
    PRINT 'Iniciando cálculo RMF Activos Extranjeros v4.1';
    ...
    -- 4. Calcular meses hasta la mitad del periodo (CORREGIDO según Excel)
    UPDATE #ActivosCalculo
    SET Meses_Hasta_Mitad_Periodo =
        CASE
            ...
            -- Caso: Activo adquirido en el año ANTES de junio (contar meses INCLUSIVE)
            WHEN FECHA_COMPRA <= @Fecha_30_Junio
            THEN DATEDIFF(MONTH, FECHA_COMPRA, @Fecha_30_Junio) + 1

            -- Caso: Activo adquirido DESPUÉS de junio (mitad del periodo desde adquisición hasta diciembre)
...
PRINT 'Stored procedure sp_Calcular_RMF_Activos_Extranjeros v4.1 creado exitosamente';
GO
