-- =============================================
-- DROP y RE-CREATE del Stored Procedure v4.6
-- CAMBIOS v4.6:
-- - CRÍTICO: Mantiene filtro ID_PAIS > 1 para evitar duplicación
-- - Activos mexicanos con ManejaUSGAAP='S' se procesan en SP Nacionales usando CostoMXN
-- - Corrige problema de duplicación donde activos con ID_PAIS=1 y ManejaUSGAAP='S'
--   se calculaban dos veces (una en cada SP)
-- - Actualiza número de versión a v4.6
-- =============================================
...
BEGIN
    ...
    PRINT '========================================';
    PRINT 'Iniciando cálculo RMF Activos Extranjeros v4.6';
...
PRINT 'Stored procedure sp_Calcular_RMF_Activos_Extranjeros v4.6 creado exitosamente';
GO

-- =============================================
-- DOCUMENTACIÓN DE CAMBIOS v4.6
-- =============================================
/*
CAMBIOS PRINCIPALES EN v4.6:

1. CORRECCIÓN CRÍTICA - PREVENCIÓN DE DUPLICADOS:
   ...
   - Elimina duplicación de cálculos que ocurría en versiones incorrectas
...
Los dos SPs deben ser mutuamente exclusivos para evitar duplicación.
*/
