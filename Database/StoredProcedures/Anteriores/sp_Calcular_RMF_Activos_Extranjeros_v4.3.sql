-- =============================================
-- DROP y RE-CREATE del Stored Procedure v4.3
-- CAMBIOS v4.3:
-- - Agrega columnas nuevas: Tasa_Anual, Dep_Anual, Valor_Reportable_USD,
--   Fecha_Adquisicion, Fecha_Baja
-- - Todas las columnas del Excel ahora se guardan en Calculo_RMF
-- =============================================
...
BEGIN
    ...
    PRINT '========================================';
    PRINT 'Iniciando cálculo RMF Activos Extranjeros v4.3';
    ...
    -- 13. Insertar resultados en Calculo_RMF (con columnas nuevas)
...
PRINT 'Stored procedure sp_Calcular_RMF_Activos_Extranjeros v4.3 creado exitosamente';
GO
