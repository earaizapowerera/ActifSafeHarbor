-- =============================================
-- DROP y RE-CREATE del Stored Procedure v4
-- CAMBIOS v4:
-- - Maneja PROPIOS (FLG_PROPIO = 1) Y NO PROPIOS (FLG_PROPIO = 0)
-- - NO PROPIOS: Safe Harbor 10% MOI directo (sin depreciación)
-- - PROPIOS: Cálculo completo con depreciación + regla 10% MOI
-- =============================================
...
BEGIN
    ...
    PRINT '========================================';
    PRINT 'Iniciando cálculo RMF Activos Extranjeros v4';
...
PRINT 'Stored procedure sp_Calcular_RMF_Activos_Extranjeros v4.0 creado exitosamente';
GO
