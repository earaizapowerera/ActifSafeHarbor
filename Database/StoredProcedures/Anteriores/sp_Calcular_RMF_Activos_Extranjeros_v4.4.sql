-- =============================================
-- DROP y RE-CREATE del Stored Procedure v4.4
-- CAMBIOS v4.4:
-- - Agrega columnas INPC: INPC_Adqu, INPC_Mitad_Ejercicio, INPC_Mitad_Periodo
-- - Estas columnas se llenan desde Staging_Activo
-- - Aunque activos extranjeros NO usan INPC en cálculos, se guardan para referencia
-- =============================================
...
BEGIN
    ...
    PRINT '========================================';
    PRINT 'Iniciando cálculo RMF Activos Extranjeros v4.4';
    ...
    -- Crear tabla temporal (AGREGANDO COLUMNAS INPC)
    ...
    -- 2. Insertar TODOS los activos extranjeros (propios Y no propios) CON INPC
    INSERT INTO #ActivosCalculo (
        ID_Staging, ID_NUM_ACTIVO, ID_ACTIVO, DESCRIPCION,
        FLG_PROPIO, MOI, Tasa_Anual, Tasa_Mensual,
    ...
    -- 2.5. Calcular Depreciación Anual
    UPDATE #ActivosCalculo
    SET Dep_Anual = MOI * Tasa_Anual;

    -- 2.6. Calcular INPC_Mitad_Periodo (para activos extranjeros es igual a INPC_Mitad_Ejercicio)
    -- Nota: Para activos mexicanos este valor varía según el caso
    UPDATE #ActivosCalculo
    ...
    -- 13. Insertar resultados en Calculo_RMF (CON COLUMNAS INPC)
...
PRINT 'Stored procedure sp_Calcular_RMF_Activos_Extranjeros v4.4 creado exitosamente';
GO
