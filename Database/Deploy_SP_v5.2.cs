...
class Program
{
    static void Main()
    {
        ...
        string sqlFile = "/Users/enrique/ActifRMF/Database/Deploy_SP_v5.2_AUTO.sql";

        Console.WriteLine("========================================");
        Console.WriteLine("DEPLOY: SP Calcular RMF Activos NACIONALES v5.2");
        Console.WriteLine("========================================");
        Console.WriteLine();
        ...
        using (var connection = new SqlConnection(connectionString))
        {
            ...
            Console.WriteLine("========================================");
            Console.WriteLine("✓ SP v5.2 desplegado exitosamente");
            Console.WriteLine("========================================");
        }
    }
}
