...
class Program
{
    static void Main()
    {
        ...
        string sqlFile = "/Users/enrique/ActifRMF/Database/StoredProcedures/sp_Calcular_RMF_Activos_Extranjeros_v4.4.sql";
        ...
        using (var connection = new SqlConnection(connectionString))
        {
            ...
            Console.WriteLine();
            Console.WriteLine("========================================");
            Console.WriteLine("✓ Stored Procedure v4.4 desplegado exitosamente");
            Console.WriteLine("========================================");
        }
    }
}
