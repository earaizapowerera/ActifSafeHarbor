...
class Program
{
    static void Main()
    {
        ...
        string sqlFile = "/Users/enrique/ActifRMF/Database/Deploy_SP_v5.3_AUTO.sql";

        Console.WriteLine("========================================");
        Console.WriteLine("DEPLOY: SP Calcular RMF Activos NACIONALES v5.3");
        Console.WriteLine("========================================");
        Console.WriteLine();
        ...
        using (var connection = new SqlConnection(connectionString))
        {
            ...
            Console.WriteLine("========================================");
            Console.WriteLine("✓ SP v5.3 desplegado exitosamente");
            Console.WriteLine("========================================");
        }
    }
}
