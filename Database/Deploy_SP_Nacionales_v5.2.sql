-- =============================================
-- DEPLOY: SP Calcular RMF Activos NACIONALES v5.1
-- SAFE HARBOR + VALIDACIÓN INPC
-- =============================================
...
BEGIN
    ...
    PRINT '========================================';
    PRINT 'Cálculo RMF Activos Nacionales v5.1';
    PRINT 'SAFE HARBOR + VALIDACIÓN INPC';
...
PRINT 'SP sp_Calcular_RMF_Activos_Nacionales v5.1 desplegado exitosamente';
PRINT 'Cambios v5.1:';
PRINT '  - Validación de INPC faltantes';
PRINT '  - Marcado de ERROR en Observaciones cuando no encuentra INPC';
PRINT '  - Reporte detallado de qué INPCs faltan (Año/Mes)';
GO
