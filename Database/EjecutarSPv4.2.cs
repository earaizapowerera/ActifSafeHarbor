...
class Program
{
    static void Main()
    {
        ...
        string sqlFile = "/Users/enrique/ActifRMF/Database/StoredProcedures/sp_Calcular_RMF_Activos_Extranjeros_v4.2.sql";
        ...
        using (var connection = new SqlConnection(connectionString))
        {
            ...
            Console.WriteLine();
            Console.WriteLine("========================================");
            Console.WriteLine("✓ Stored procedure v4.2 creado exitosamente");
            Console.WriteLine("========================================");
        }
    }
}
