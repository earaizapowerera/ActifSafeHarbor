    ...
    try
    {
        ...
        var queryNacionales = @"
            SELECT
                ...
                c.Saldo_Inicio_Año AS Saldo_Por_Deducir_ISR_Al_Inicio_Año,
                -- CAMPOS FISCALES
                c.INPCCompra AS INPCAdquisicion,
                c.INPC_Mitad_Ejercicio AS INPCMitadEjercicio,
                c.Factor_Actualizacion_Saldo AS FactorActualizacionPaso1,
                c.Saldo_Actualizado AS SaldoActualizadoPaso1,
                c.Dep_Fiscal_Ejercicio AS DepreciacionFiscalDelEjercicio,
                c.INPCCompra AS INPCAdquPaso2,
                c.INPC_Mitad_Periodo AS INPCMitadPeriodo,
                c.Factor_Actualizacion_Dep AS FactorActualizacionPaso2,
                c.Dep_Actualizada AS DepreciacionFiscalActualizada,
